...
prompt_color() {
    PS1="${GREY}[${GREY}\w${GREY}]\n${GREY}${COLOR1}\u${GREY}@${COLOR2}\h${GREY}${COLOR2}$P${PS_CLEAR} "
...
# Some other aliases so I don't fuck myself
alias rm='rm -iv'
alias cp='cp -v'
...
# Shit for ImageMagick
export MAGICK_HOME="$HOME/apps/ImageMagick-6.6.1"
...
# Shit for rbenv https://github.com/sstephenson/rbenv
